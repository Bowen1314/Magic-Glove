...
<img src="full_assembly.png" width="500" alt="成品展示">

## 硬件清单 🛠️
* **主控板**：Seeed Studio XIAO ESP32-S3 (Sense版本亦可)。
- **传感器**：MPU-6050 (GY-521) 六轴陀螺仪加速度计。
- **反馈组件**：MH-FMD 低电平触发蜂鸣器。
- **其他**：轻触按键、导线、用于固定组件的手套。

### 硬件连接架构图 🏗️
```mermaid
graph TD
    subgraph "魔法手套硬件系统"
        MCU[XIAO ESP32-S3 主控]
        IMU[MPU-6050 陀螺仪]
        BZ[MH-FMD 蜂鸣器]
        BTNS{交互按键组}
        
        MCU -- I2C 总线: D4/D5 --- IMU
        MCU -- 数字信号: D6 --- BZ
        MCU -- GPIO 信号: D0/D1/D2/D3/D10 --- BTNS
